    ...
    <div className="p-4">
      <Section title="Core">
        <Subsection title="Colors">
          <table className="table-auto text-center">
            <tr>
              <td>
                ...
                border
                <br />
                divide (like border, but auto)
                <br />
                ring (semi transparent border)
                <br />
                ring-offset (secondary inner ring)
                <br />
                placeholder
                <br />
                from (for gradients)
          ...
          <p>
            bg-opacity- text-opacity- placeholder-opacity-100 75 50 25 0 (pair
            with hover: focus:)
          </p>
        </Subsection>
        ...
        <Subsection title="Variants">
          <p>
            Common variants - hover: focus: active: and focus-visible: for a
            keyboard-only focus
          </p>
          <p>
            disabled: visited: checked: first: last: odd: even:{' '}
            <span className="font-bold">dark:</span>
          </p>
          <div>
            If parent has `group`, then can use group-hover: and group-focus: on
            children
          </div>
      ...
      <Section title="Containers">
        <Subsection title="General">
          <p>
            Design pages mobile first: no prefix everywhere, and then start
            adding sm: md: lg: xl: 2xl:
          </p>
          <p>
            `container` class sets max-width to min-width of the current
            breakpoint
          </p>
        ...
        <Subsection title="Grid">
          ...
          <p>
            justify- (items in a container) justify-items- (items in their own
            &quot;cell&quot;) justify-self- (-items but individually
          </p>
      ...
      <Section title="Text">
        <Subsection title="Main">
          ...
          <p>
            font-thin / extralight light normal medium semibold bold extrabold
            black
          </p>
        </Subsection>
        <Subsection title="Formatting">
          ...
          <p>
            Line height: fixed: leading-3 (-10) / relative: none tight snug
            normal relaxed loosed
          </p>
          ...
          <p>
            for cells and inline: vertical: align-baseline top middle bottom
        ...
        <Subsection title="Special features">
          ...
          <p className="proportional-nums">
            12121 (.proportional-nums - monospace like)
          </p>
          <p className="proportional-nums">90909</p>
          <p className="tabular-nums">
            12121 (.tabular-nums - tab aligned width)
          </p>
          <p className="tabular-nums">90909</p>
          <p className="diagonal-fractions">
            1/2 3/4 5/6 (.diagonal-fractions)
          </p>
        </Subsection>
      </Section>
      <Section title="Background">
        <Subsection title="Image">
          ...
          <p className="font-bold">
            bg-clip-border padding content text (text - clip bg though text
          </p>
      ...
      <Section title="Outlines">
        <Subsection title="Rounding">
          <p>
            rounded rounded-sm md lg xl 2xl 3xl full rounded-t-2xl
            rounded-bl-none
          </p>
        </Subsection>
        ...
        <Subsection title="Shadow">
          <p>
            ...
            <span className="font-bold">inner</span> none
          </p>
        </Subsection>
      ...
      <Section title="Animations">
        <Subsection title="Transition">
          <p className="font-bold">
            transition (main) transition-none all colors opacity shadow
            transform
          </p>
        ...
        <Subsection title="Animate">
          ...
          <p className="font-bold">
            motion-safe:animate-bounce motion-reduce:animate-bounce
          </p>
        </Subsection>
      </Section>
      <Section title="Transforms">
        ...
        <Subsection title="Transforms">
          ...
          <p>
            translate-x-0 0.4 1 1.5 2 2.5 3 3.5 4 px 1/2 full -translate-y-5
          </p>
      ...
      <Section title="Interactivity">
        <p className="font-bold">
          appearance-none - reset browser specific el styles
        </p>
        ...
        <p>
          Selection: select-none text{' '}
          <span className="font-bold">all (all on any click)</span> auto
        </p>
      </Section>
      <Section title="Svg">
        <p>fill-current - fill SVG with current text color</p>
        <p>
          stroke-current - stroke (border) SVG with current text color (e.x.
          text-green-200)
        </p>
